...
var ansResolver = /** @class */ (function () {
    function ansResolver(client, indexer) {
        ...
        this.getNamesOwnedByAddress = function (account, socials, metadata, limit) { return __awaiter(_this, void 0, void 0, function () {
            var accountInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!(_a.sent()))
                            throw new errors_1.AddressValidationError();
                        return [4 /*yield*/, this.resolverInstance.getNamesOwnedByAddress(account, socials, metadata, limit)];
                    case 2:
                        accountInfo = _a.sent();
