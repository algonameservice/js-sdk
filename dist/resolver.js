...
var require_errors = __commonJS({
  "src/errors.js"(exports) {
    ...
    var NameNotRegisteredError2 = function(_super) {
      __extends(NameNotRegisteredError3, _super);
      function NameNotRegisteredError3(name) {
      ...
      return NameNotRegisteredError3;
    }(Error);
    exports.NameNotRegisteredError = NameNotRegisteredError2;
...
var Resolver = class extends import_cachedApi.default {
  ...
  async owner() {
    ...
    throw new import_errors.NameNotRegisteredError(this.name.name);
  }
  async text(key) {
    var _a, _b;
    const domainInformation = await this.resolveName();
  ...
  async content() {
    ...
    throw new import_errors.NameNotRegisteredError(this._name);
  }
};
