          ...
          return __generator3(this, function(_a) {
            switch (_a.label) {
              ...
              case 3:
                ...
                appArgs = [];
                appArgs.push((0, util_js_13.toIntArray)(method));
...
var init_name = __esm({
  "src/name.js"() {
    ...
    transactions_js_1 = (init_transactions(), __toCommonJS(transactions_exports));
