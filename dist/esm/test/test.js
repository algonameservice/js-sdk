...
describe("Testing name resolution methods", function () {
    beforeEach("Creating Client and Indexer instances", function () {
        algodClient = new algosdk.Algodv2({ "X-API-KEY": API_KEY }, "https://mainnet-algorand.api.purestake.io/ps2", "");
        indexerClient = new algosdk.Indexer({ "X-API-KEY": API_KEY }, "https://mainnet-algorand.api.purestake.io/idx2", "");
    ...
    it("Prepares a list of transactions to register a name", async function () {
        ...
        const nameRegistrationTxns = await sdk
            .name("ansone.algo")
            .register("PD2CGHFAZZQNYBRPZH7HNTA275K3FKZPENRSUXWZHBIVNPHVDFHLNIUSXU", 1);
    ...
    it("Prepares a list of transactions to set properties", async function () {
        this.timeout(100000);
        const updatePropertyTxns = await name.update("PD2CGHFAZZQNYBRPZH7HNTA275K3FKZPENRSUXWZHBIVNPHVDFHLNIUSXU", {
            discord: "ansdiscord",
            github: "ansgithub",
        });
    ...
    it("Prepares a list of transactions to renew name", async function () {
        this.timeout(100000);
        const nameRenewalTxns = await name.renew("PD2CGHFAZZQNYBRPZH7HNTA275K3FKZPENRSUXWZHBIVNPHVDFHLNIUSXU", 2);
    ...
    it("Prepares a transaction to initiate name transfer", async function () {
        this.timeout(100000);
        const nameTransferTxn = await name.initTransfer("PD2CGHFAZZQNYBRPZH7HNTA275K3FKZPENRSUXWZHBIVNPHVDFHLNIUSXU", "RANDGVRRYGVKI3WSDG6OGTZQ7MHDLIN5RYKJBABL46K5RQVHUFV3NY5DUE", 1);
    ...
    it("Prepares a transaction to accept name transfer", async function () {
        const acceptNameTranserTxn = await name.acceptTransfer("RANDGVRRYGVKI3WSDG6OGTZQ7MHDLIN5RYKJBABL46K5RQVHUFV3NY5DUE", "PD2CGHFAZZQNYBRPZH7HNTA275K3FKZPENRSUXWZHBIVNPHVDFHLNIUSXU", 1);
