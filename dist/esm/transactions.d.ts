...
export declare class Transactions extends CachedApi {
    private name;
    constructor(client: algosdk.Algodv2, indexer: algosdk.Indexer, name: Name | string, network?: string, app?: number);
    ...
    prepareSetDefaultDomainTxn(address: string): Promise<algosdk.Transaction>;
